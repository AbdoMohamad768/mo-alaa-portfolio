...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className="bg-[#050509] text-neutral-50 antialiased">
            ...
            <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-4">
              ...
              <nav className="flex items-center gap-6 text-sm text-neutral-300">
                ...
                <a
                  ...
                  target="_blank"
                  className="transition-colors text-black hover:bg-gray-800 hover:text-emerald-300 bg-white rounded-3xl px-4 py-2"
                >
                  Resume
                </a>
              </nav>
