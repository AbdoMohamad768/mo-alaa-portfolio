export function ConnectSection() {
  return (
    <section
      id="connect"
      className="mt-24 space-y-6 rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8 fade-in-up"
    >
      ...
      <p className="max-w-xl text-sm text-neutral-400 sm:text-base">
        ...
        something new from scratch, I&apos;d love to hear about what you&apos;re
        working on.
      </p>
      ...
      <div className="flex flex-wrap gap-3 pt-2">
        <a
          ...
          className="inline-flex items-center justify-center rounded-full hover:bg-gray-800 hover:text-emerald-300 bg-neutral-50 px-5 py-2.5 text-sm font-medium text-black transition"
        >
          Email me
        </a>
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center justify-center rounded-full border border-white/20 bg-black/40 px-5 py-2.5 text-sm font-medium text-neutral-100 transition hover:border-white hover:text-white"
        >
          Connect on LinkedIn
        </a>
      </div>
