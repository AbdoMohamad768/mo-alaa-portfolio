export function AboutSection() {
  return (
    <section
      id="about"
      className="mt-24 grid gap-10 md:grid-cols-[minmax(0,1.5fr)_minmax(0,1.4fr)] fade-in-up"
    >
      <div className="space-y-4">
        ...
        <p className="text-sm text-neutral-300 sm:text-base">
          ...
          about clarity, usability, and creating interfaces that feel effortless
          to use. I enjoy collaborating closely with teams, turning messy
          problems into simple, thoughtful experiences.
        </p>
        <p className="text-sm text-neutral-300 sm:text-base">
